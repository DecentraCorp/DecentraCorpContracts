...
class BasePackageProject {
    ...
    setImplementation(contract, contractName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.Loggy.onVerbose(`set-implementation-${contractName}`, `Implementation set: ${implementation.address}`);
    ...
    unsetImplementation(contractName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            Logger_1.Loggy.onVerbose(`unset-implementation-${contractName}`);
        });
    }
