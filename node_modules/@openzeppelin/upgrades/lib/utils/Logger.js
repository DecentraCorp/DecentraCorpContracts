...
exports.Loggy = {
    ...
    update(reference, { spinnerAction, text }, file) {
        if (this.logs[reference]) {
            ...
            this.logs[reference] = Object.assign({}, this.logs[reference], args);
            this._log(reference);
        }
    },
    succeed(reference, text) {
        ...
        this.logs[reference] = Object.assign({}, this.logs[reference], { spinnerAction: SpinnerAction.Succeed, text });
        this._log(reference);
    },
    fail(reference, text) {
        if (!text && this.logs[reference])
            text = this.logs[reference].text;
        this.logs[reference] = Object.assign({}, this.logs[reference], { spinnerAction: SpinnerAction.Fail, text });
        this._log(reference);
    },
