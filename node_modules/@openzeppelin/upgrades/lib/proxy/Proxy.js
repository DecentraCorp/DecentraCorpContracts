...
class Proxy {
    ...
    implementation() {
        return __awaiter(this, void 0, void 0, function* () {
            const hashedLabel = web3_utils_1.toHex(web3_utils_1.toBN(ZWeb3_1.default.sha3(Constants_1.IMPLEMENTATION_LABEL)).sub(web3_utils_1.toBN(1)));
            let storage = yield this.getStorageAt(hashedLabel);
            // TODO-v3: Remove deprecated 'zos' support
            if (storage === '0x0') {
                storage = yield this.getStorageAt(ZWeb3_1.default.sha3(Constants_1.DEPRECATED_IMPLEMENTATION_LABEL));
            }
    ...
    admin() {
        return __awaiter(this, void 0, void 0, function* () {
            const hashedLabel = web3_utils_1.toHex(web3_utils_1.toBN(ZWeb3_1.default.sha3(Constants_1.ADMIN_LABEL)).sub(web3_utils_1.toBN(1)));
            let storage = yield this.getStorageAt(hashedLabel);
            // TODO-v3: Remove deprecated 'zos' support
            if (storage === '0x0') {
                storage = yield this.getStorageAt(ZWeb3_1.default.sha3(Constants_1.DEPRECATED_ADMIN_LABEL));
            }
            return Addresses_1.uint256ToAddress(storage);
        });
    }
