...
class NetworkFile {
    static getManifestVersion(network) {
        const file = upgrades_1.FileSystem.parseJsonIfExists(`zos.${network}.json`);
    ...
    contractAliasesMissingFromPackage() {
        return lodash_difference_1.default(this.contractAliases, this.projectFile.contractAliases);
    }
    ...
    dependenciesNamesMissingFromPackage() {
        return lodash_difference_1.default(this.dependenciesNames, this.projectFile.dependenciesNames);
    }
    ...
    static getExistingFilePath(network, dir = process.cwd(), ...paths) {
        ...
        return [...paths, `${dir}/zos.${network}.json`, `${dir}/${constants_1.OPEN_ZEPPELIN_FOLDER}/${network}.json`].find(upgrades_1.FileSystem.exists);
    }
    hasChanged() {
        const currentNetworkFile = upgrades_1.FileSystem.parseJsonIfExists(this.filePath);
