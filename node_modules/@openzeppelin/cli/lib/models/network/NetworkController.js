...
class NetworkController {
    ...
    push(reupload = false, force = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (lodash_isempty_1.default(contracts) && lodash_isempty_1.default(changedLibraries)) {
                upgrades_1.Loggy.noSpin(__filename, 'push', `after-push`, `All contracts are up to date`);
            }
            else {
                upgrades_1.Loggy.noSpin(__filename, 'push', `after-push`, `All contracts have been deployed`);
            }
        });
    }
    // DeployerController
    ...
    _contractsListForPush(onlyChanged = false, changedLibraries = []) {
        ...
        const pipeline = [
            ...
            contracts => lodash_map_1.default(contracts, ([contractAlias, contractName]) => [contractAlias, upgrades_1.Contracts.getFromLocal(contractName)]),
    ...
    _errorForLocalContractsDeployed() {
        const [contractsDeployed, contractsMissing] = lodash_partition_1.default(this.projectFile.contractAliases, alias => this.isContractDeployed(alias));
    ...
    publish() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.appAddress) {
                upgrades_1.Loggy.noSpin(__filename, 'publish', `Project is already published to ${this.network}`);
                return;
            }
    ...
    _checkDeploymentAddress(salt) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((yield upgrades_1.ZWeb3.getCode(deploymentAddress)) !== '0x')
    ...
    checkInitialization(contract, calledInitMethod) {
        ...
        if (initializerMethods.length === 0)
            return;
        upgrades_1.Loggy.noSpin.warn(__filename, 'validateContract', `validate-contract`, `Possible initialization method (${lodash_uniq_1.default(initializerMethods).join(', ')}) found in contract. Make sure you initialize your instance.`);
    }
    // Proxy model
    _updateTruffleDeployedInformation(contractAlias, implementation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (contractName) {
                ...
                const data = upgrades_1.FileSystem.parseJson(path);
                if (!data.networks) {
                    data.networks = {};
                }
                ...
                upgrades_1.FileSystem.writeJson(path, data);
            }
        });
    }
    // Proxy model
    ...
    _upgradeProxy(proxy, initMethod, initArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.networkFile.updateProxy(proxy, aProxy => (Object.assign({}, aProxy, { implementation: newImplementation, version: upgrades_1.semanticVersionToString(projectVersion) })));
            }
            catch (error) {
    ...
    _fetchOwnedProxies(packageName, contractAlias, proxyAddress, ownerAddress) {
        ...
        if (lodash_isempty_1.default(proxies)) {
            upgrades_1.Loggy.noSpin(__filename, '_fetchOwnedProxies', `fetch-owned-proxies`, `No contract instances that match${criteriaDescription} were found`);
            return [];
        }
    ...
    deployDependencies() {
        return __awaiter(this, void 0, void 0, function* () {
            yield async_1.allPromisesOrError(lodash_map_1.default(this.projectFile.dependencies, (version, dep) => this.deployDependencyIfNeeded(dep, version)));
        });
    }
    ...
    handleDependenciesLink() {
        return __awaiter(this, void 0, void 0, function* () {
            yield async_1.allPromisesOrError(lodash_concat_1.default(lodash_map_1.default(this.projectFile.dependencies, (version, dep) => this.linkDependency(dep, version)), lodash_map_1.default(this.networkFile.dependenciesNamesMissingFromPackage(), dep => this.unlinkDependency(dep))));
        });
    }
    // DependencyController
