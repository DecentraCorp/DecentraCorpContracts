...
const { buildCallData, callDescription } = upgrades_1.ABI;
class TransactionController {
    ...
    getBalanceOf(accountAddress, contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            if (contractAddress) {
                ...
                const balance = yield upgrades_1.ZWeb3.getBalance(accountAddress);
    ...
    callContractMethod(proxyAddress, methodName, methodArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                lodash_isnull_1.default(parsedResult) || lodash_isundefined_1.default(parsedResult) || parsedResult === '()' || parsedResult.length === 0
    ...
    getTokenInfo(accountAddress, contractAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const contract = upgrades_1.ZWeb3.contract(constants_1.ERC20_PARTIAL_ABI, contractAddress);
