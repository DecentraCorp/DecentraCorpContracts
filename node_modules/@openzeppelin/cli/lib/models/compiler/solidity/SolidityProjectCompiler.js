...
function compileProject(options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const projectCompiler = new SolidityProjectCompiler(Object.assign({}, options, { inputDir: options.inputDir || upgrades_1.Contracts.getLocalContractsDir(), outputDir: options.outputDir || upgrades_1.Contracts.getLocalBuildDir() }));
...
class SolidityProjectCompiler {
    ...
    _shouldCompile() {
        ...
        const currentSettings = Object.assign({ optimizer: SolidityContractsCompiler_1.DEFAULT_OPTIMIZER, evmVersion: SolidityContractsCompiler_1.DEFAULT_EVM_VERSION }, lodash_omitby_1.default(this.options, lodash_isundefined_1.default));
