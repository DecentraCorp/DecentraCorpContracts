...
exports.DEFAULT_EVM_VERSION = 'constantinople';
...
class SolidityContractsCompiler {
    constructor(compiler, contracts, { optimizer, evmVersion } = {}) {
        ...
        this.evmVersion = evmVersion || exports.DEFAULT_EVM_VERSION;
    ...
    _buildSources() {
        return this.contracts.reduce((sources, contract) => {
            upgrades_1.Loggy.onVerbose(__filename, '_buildSources', `compile-contract-file-${contract.fileName}`, `Compiling ${contract.fileName}`);
    ...
    _buildContractsSchemas(solcOutput) {
        ...
        return lodash_flatmap_1.default(paths, (fileName) => {
