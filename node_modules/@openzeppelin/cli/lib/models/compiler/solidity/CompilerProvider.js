...
function resolveCompilerVersion(requiredSemver) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const requiredSemvers = lodash_uniq_1.default(lodash_compact_1.default(lodash_castarray_1.default(requiredSemver))).map(str => str.startsWith('v') ? str.slice(1) : str);
...
function getCompilerVersion(requiredSemvers, solcList) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (requiredSemvers.length === 1) {
            const build = lodash_reverse_1.default(solcList.builds).find(b => b.path.startsWith(`soljson-v${requiredSemvers[0]}`));
            if (build)
                return build;
        }
