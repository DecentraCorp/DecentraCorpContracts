...
const ConfigManager = {
    ...
    initNetworkConfiguration(options = {}, silent, root = process.cwd()) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { network: networkName, from, timeout } = Session_1.default.getOptions(options, silent);
            ...
            upgrades_1.Contracts.setSyncTimeout(timeout * 1000);
            upgrades_1.Contracts.setArtifactsDefaults(artifactDefaults);
            try {
                upgrades_1.ZWeb3.initialize(provider);
                yield upgrades_1.ZWeb3.checkNetworkId(networkId);
                const txParams = {
                    from: upgrades_1.ZWeb3.toChecksumAddress(from || artifactDefaults.from || (yield upgrades_1.ZWeb3.defaultAccount())),
                };
