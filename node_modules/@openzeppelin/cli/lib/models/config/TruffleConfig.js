...
const TruffleConfig = {
    ...
    exists(path = process.cwd()) {
        ...
        return upgrades_1.FileSystem.exists(truffleFile) || upgrades_1.FileSystem.exists(truffleConfigFile);
    },
    ...
    getTruffleConfigFileName(path) {
        const truffleFile = `${path}/truffle.js`;
        return upgrades_1.FileSystem.exists(truffleFile) ? 'truffle.js' : 'truffle-config.js';
    },
};
