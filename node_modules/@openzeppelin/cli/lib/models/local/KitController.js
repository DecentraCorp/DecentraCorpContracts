...
class KitController {
    unpack(url, workingDirPath = '', config) {
    ...
    verifyRepo(url) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!url)
                throw Error('A url must be provided.');
            try {
                const config = (yield axios_1.default.get(url.replace('.git', '/stable/kit.json').replace('github.com', 'raw.githubusercontent.com'))).data;
