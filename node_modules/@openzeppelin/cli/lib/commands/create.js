...
function commandActions(contractFullName, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { network: promptedNewtork, contractFullName: promptedContractFullName } = yield promptForCreate(contractFullName, options);
        const { network, txParams } = yield ConfigManager_1.default.initNetworkConfiguration(Object.assign({}, options, { network: promptedNewtork }));
        ...
        yield push_1.default.runActionIfNeeded(promptedContractFullName, network, Object.assign({}, options, { network: promptedNewtork, force: true }));
        yield action(promptedContractFullName, Object.assign({}, options, { network, txParams }));
...
function action(contractFullName, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const args = lodash_pickby_1.default({
            packageName,
            contractAlias,
            methodName,
            methodArgs,
        ...
        if (!(yield migrations_1.hasToMigrateProject(network)))
            process.exit(0);
        yield create_1.default(Object.assign({}, args, { network, txParams }));
...
function getCommandProps() {
    return Object.assign({}, prompt_1.networksList('network', 'list'), prompt_1.contractsList('contractFullName', 'Pick a contract to instantiate', 'list', 'all'));
}
