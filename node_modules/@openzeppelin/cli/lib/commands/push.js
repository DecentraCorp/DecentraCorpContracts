...
function action(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { network, txParams } = yield ConfigManager_1.default.initNetworkConfiguration(Object.assign({}, options, prompted));
        const promptDeployDependencies = yield promptForDeployDependencies(deployDependencies, network, interactive);
        yield push_1.default(Object.assign({ deployProxyAdmin,
            deployProxyFactory,
            force,
            reupload,
            network,
...
function runActionIfNeeded(contractName, network, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (interactive) {
            if (force ||
                ...
                yield action(Object.assign({}, options, { dontExitProcess: true }));
            }
        }
    });
}
...
function getCommandProps(networkName) {
    return Object.assign({}, prompt_1.networksList('network', 'list'), { deployDependencies: {
            type: 'confirm',
