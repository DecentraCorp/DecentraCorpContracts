...
function action(accountAddress, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield ConfigManager_1.default.initNetworkConfiguration(Object.assign({}, options, promptedConfig));
        yield balance_1.default({
...
function getCommandProps() {
    return Object.assign({}, prompt_1.networksList('network', 'list'), { accountAddress: {
            type: 'input',
