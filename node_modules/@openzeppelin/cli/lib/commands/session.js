...
function action(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (close) {
            ...
            const accounts = yield upgrades_1.ZWeb3.accounts();
            const promptedSession = yield prompt_1.promptIfNeeded({ opts: { timeout, from, expires }, props: getCommandProps(accounts) }, interactive);
            session_1.default(Object.assign({ close }, promptedNetwork, promptedSession));
        }
...
function getCommandProps(accounts = []) {
    return Object.assign({}, prompt_1.networksList('network', 'list'), { from: {
            type: 'list',
