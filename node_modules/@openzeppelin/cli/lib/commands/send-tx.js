...
function action(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { network, txParams } = yield ConfigManager_1.default.initNetworkConfiguration(Object.assign({}, options, networkOpts));
        ...
        const args = lodash_pickby_1.default(Object.assign({}, methodParams, { proxyAddress: proxyReference, value,
            gas }));
        yield send_tx_1.default(Object.assign({}, args, { network, txParams }));
...
function getCommandProps(network) {
    return Object.assign({}, prompt_1.networksList('network', 'list'), { proxy: {
