...
function action(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { txParams } = yield ConfigManager_1.default.initNetworkConfiguration(promptedConfig, true);
        const transferOpts = { from, to, value };
        const transferProps = getCommandProps(yield upgrades_1.ZWeb3.accounts(), unit);
        const promptedTransfer = yield prompt_1.promptIfNeeded({ opts: transferOpts, props: transferProps }, interactive);
        yield transfer_1.default(Object.assign({}, promptedTransfer, { unit, txParams }));
